...
* Presentation for the defense can be found [here.](/assets/docs/Presentation-master.pdf)
* The source code of the *HyggeWasm* compiler can be found [here.](https://github.com/trolund/hygge-wasm)
