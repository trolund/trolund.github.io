(function (lib, img, cjs, ss, an) {
  ...
  (lib.Bitmap_1_pngcopyai = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        'Ah3KFQgkgCg2AAIhgABIBWknICLnXICInYQAIgdANgLQAPgMAcACQAkACA2AAIBggBIg4DDQj0M/g8DUQgJAdgNAKQgNALgYAAIgGAAg',
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        'AkPIvQgig4gWgpQgDgGAGgQQAFgNAIgLQBniADQj/IAZghIkelhQg5hHgCgZQgCgZAwhOIBAhpIIbKRIobKRIg9hig',
      );
