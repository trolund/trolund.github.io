...
export default function ProjectItem({
  ...
  return (
    <article className="scroll-reveal border-border-color hover:shadow-custom-low group relative overflow-hidden rounded-[28px] border bg-(--bg) transition-[transform,translate,box-shadow] duration-300 hover:-translate-y-1">
