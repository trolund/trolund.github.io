    ...
    <>
      ...
      >
        <div className="mb-12 flex flex-col items-center justify-center gap-4">
          <button
            type="button"
            className="border-border-color text-content-text shadow-custom hover:shadow-custom-low bg-(--bg) inline-flex items-center justify-center rounded-full border px-6 py-2 text-sm font-semibold transition-transform duration-200 hover:-translate-y-0.5 disabled:pointer-events-none disabled:opacity-0"
            onClick={loadMore}
