...
export default function Footer() {
  return (
    <div
      className={cn(
        'flex w-full flex-col items-center justify-center bg-cover bg-center bg-no-repeat p-5 pb-4',
        styles.footerBackground,
      )}
    >
      <footer
        className={cn(
          'z-45 rounded-lg border border-border-color bg-footer/60 backdrop-blur-2xl',
          styles.footer,
        )}
      >
        <Container>
