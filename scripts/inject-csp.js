...
const CSP_META_REGEX = /<meta\b[^>]*http-equiv=["']Content-Security-Policy["'][^>]*>/gi;
...
function buildCsp(html) {
  ...
  const hasInlineHandlers = INLINE_HANDLER_REGEX.test(html) || JAVASCRIPT_URL_REGEX.test(html);
